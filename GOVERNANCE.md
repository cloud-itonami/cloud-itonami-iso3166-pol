...
`cloud-itonami-iso3166-pol` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Polish-licensed counsel or a registered agent for whatever licensed
representation the law of Poland requires for public-procurement
filings.
