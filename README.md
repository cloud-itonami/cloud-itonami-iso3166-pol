# cloud-itonami-iso3166-pol

Open ISO 3166 Blueprint for **POL**: Poland.
...
tax registration, and local-content rules in Poland, so the operator
...
- **Not the government of Poland.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Polish-licensed counsel
...
(ISO 3166 `POL`). Required capabilities:
