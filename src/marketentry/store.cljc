(ns marketentry.store
  "SSoT for the POL market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems PL" :portal "e-Zamówienia"
             ...
             :requires-nip? true :nip-verified? true
             :drafted? false :submitted? false
             :jurisdiction "POL" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-Zamówienia"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-nip? true :nip-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-Zamówienia"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "POL" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-Zamówienia"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "POL" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-Zamówienia"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-nip? true :nip-verified? false
             :drafted? false :submitted? false
             :jurisdiction "POL" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-Zamówienia"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-nip?)    (assoc :engagement/requires-nip? requires-nip?)
    (some? nip-verified?)    (assoc :engagement/nip-verified? nip-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-nip? :engagement/nip-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-nip? (boolean (:engagement/requires-nip? m))
     :nip-verified? (boolean (:engagement/nip-verified? m))
